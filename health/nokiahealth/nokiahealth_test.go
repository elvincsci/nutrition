...
func LoadConfig() error {
	rawConfigData, err := ioutil.ReadFile("/Users/elvin/Documents/go/src/health/nokiahealth/test.toml.example")
	if err != nil {
		return err
	}
...
func TestGetBodyMeasures(t *testing.T) {
	...
	//fmt.Println("M  ", m)
	fmt.Println("Body  ", m.ParseData().Weights)
	//fmt.Println("Body  ", m.)
	//fmt.Println("Body  ", m)

	//fmt.Println(strings.Join(m.ParseData().Weights, " } "))
